...
import kotlinx.android.synthetic.main.fragment_email_phone_input.*
    ...
    private fun validation(): Boolean {
        ...
        }else
        {
            ...
            for(gmailUser in gmailUserList)
            {
                ...
                {
                    Utils.showErrorWithTextInput(activity,emailTextInputLayout,R.drawable.ic_error,getString(R.string.error_already_taken))
                    return false;
                }
